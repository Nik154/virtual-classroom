        ...
        <nav>
            ...
            {Object.keys(classInfo).length > 0 && classInfo.owner === userInfo._id?
                <nav className="center bg-white text-dark topnav">
                    ...
                    <p className="col-3 option nav-ham"><NavLink to = {`/class/${classInfo._id}/classwork`} className="link">Assignments/Tests</NavLink></p>
            ...
            : <nav className="center bg-white text-dark topnav">
                ...
                <p className="col-4 nav-ham optc"><NavLink to = {`/class/${classInfo._id}/classwork`} className="link">Assignments/Tests</NavLink></p>
